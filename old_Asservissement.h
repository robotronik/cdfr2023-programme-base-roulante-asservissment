...
#define KP_POSITIONLINEAIRE 10.0
#define KD_POSITIONLINEAIRE 3.0
#define KP_VITESSELINEAIRE 0.01
#define KI_VITESSELINEAIRE 0.2
#define KD_VITESSELINEAIRE 0
#define VITESSELINEAIREMAX 2000 //mm/s ou pas
#define VITESSELINEAIREMAXARR 500
